...
- Dial ring hover/selected: 10% scale grow, strong black drop-shadow, soft white rim; sharp mode is edge-to-edge (no feather overlap); sibling rings at 50% over a surface disc (active ring stays fully opaque)
