...
- Dial compositing: one shared bloom blur, `translateZ(0)` layers, `box-shadow` planet shadow, and gradient sun halo/shadow (no CSS blur on moving discs) so scrub stays smoother
