...
- **Superseded in part:** 2026-09-01 — horizon spectrum RGB stops lerp continuously by elevation (same stop count at every keyframe) so scrub never swaps palettes; dark keeps peach/pink/purple/blue with a slight gold Rayleigh core; light stays soft.
