...
- **Superseded in part:** 2026-08-29 — sun stays 1× below the horizon; daytime path pulls inward near 0°; stroke width maps that day’s elev min→0.2px / max→3px; adding a missing light commits undo before writing the draft.
