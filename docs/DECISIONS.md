...
- **Superseded in part:** 2026-08-30 — dial light list must not shrink `--dial-face-max`: it always flows under the face (portrait and landscape). Do not park it in the landscape left gutter — that column is only for optical centering with the timeline rail.
