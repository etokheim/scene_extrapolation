...
- **Superseded in part:** 2026-08-30 — dial light list must not shrink `--dial-face-max`: portrait keeps it under the face in leftover height; landscape moves it into the matching left grid column (grows into the dial like chips grow left from the timeline rail).
