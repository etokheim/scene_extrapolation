...
- **Superseded in part:** 2026-08-30 — landscape dial rail: date suggestion chips sit in one horizontal row above the day/month (right-aligned; chips may extend left of the rail); day/month is 26px with no calendar icon.
