...
- **Why:** The old halfway mode switch snapped white↔color (and wheel polylines) whenever day scenes were color_temp and evening scenes were HS/RGB.
- **Do not reverse without user ask.**
