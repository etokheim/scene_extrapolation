...
- **Superseded in part:** 2026-08-30 — light-ring glow is a large non-interactive clone of the dial rings (same conic fills), scaled ~2.76 and blurred behind the planet at ~0.63 opacity so bloom matches ring colors without overpowering; event spokes match the night sun-path dash (`#d8e0ff`, `5 4`, 1px) at 50% opacity; night path is also 50%.
