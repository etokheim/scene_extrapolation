...
- **Superseded in part:** 2026-08-30 — landscape dial rail: date suggestion chips sit in one horizontal nowrap row above the day/month, right-aligned so they grow left into the dial column (`overflow: visible`); day/month is 26px with no calendar icon.
...
- **Superseded in part:** 2026-08-30 — light-ring glow is a large non-interactive clone of the dial rings (same conic fills), scaled ~1.38 and blurred behind the planet so bloom matches ring colors (not elevation sky). Event spokes match the night sun-path dash (`#d8e0ff`, `5 4`, 1px) at 50% opacity; night path is also 50%.
