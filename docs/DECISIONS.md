...
- **Superseded in part:** 2026-08-29 — sun stays 1× below the horizon; near-horizon pull is marker-only (drawn path unpulled); stroke width maps that day’s elev min→0.2px / max→3px; clock enter scales/fades the face while the sun sweeps +12h to idle; adding a missing light commits undo before writing the draft.
